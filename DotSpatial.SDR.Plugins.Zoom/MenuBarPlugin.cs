...
using DotSpatial.SDR.Plugins.Zoom.Properties;
using Msg = DotSpatial.SDR.Plugins.Zoom.MessageStrings;
using DotSpatial.Topology;

namespace DotSpatial.SDR.Plugins.Zoom
{
    public class MenuBarPlugin : Extension
    {
        ...
        private void AddMenuItems()
        {
            ...
            header.Add(new SimpleActionItem(HomeMenuKey, Msg.Pan, PanTool_Click) { GroupCaption = Msg.View_Group, SmallImage = Resources.hand_16x16, LargeImage = Resources.hand_32x32 });
