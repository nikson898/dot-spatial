...
namespace DotSpatial.SDR.Plugins.Navigate
{
    public class NavigatePlugin : Extension
    {
        ...
        private void AddMenuItems()
        {
            ...
            //header.Add(new SimpleActionItem(FileMenuKey, Msg.File_New, NewProject_Click) { GroupCaption = HeaderControl.ApplicationMenuKey, SortOrder = 5, SmallImage = Resources.document_empty_16x16, LargeImage = Resources.document_empty_32x32, ToolTipText = DotSpatial.SDR.Plugins.Navigate.MessageStrings.FileNewToolTip });
            ...
            header.Add(new SimpleActionItem(HeaderControl.HomeRootItemKey, Msg.Zoom_In, ZoomIn_Click) {SortOrder = 2, GroupCaption = Msg.Zoom_Group, SmallImage = Resources.zoom_in_16x16, LargeImage = Resources.zoom_in_32x32 });
